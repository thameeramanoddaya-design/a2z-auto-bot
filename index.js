...
(async () => {
  console.log("🚀 Starting Bot on Mac Screen...");
  ...
  console.log(`📦 Found ${pendingRows.length} pending orders. Opening Browser...`);

  // Mac එකේ Chrome Browser එක Screen එකේ පෙන්නීමට headless: false යොදා ඇත
  ...
  try {
    ...
    await page.goto('https://a2ztraders.lk/index.php/Dash', { waitUntil: 'domcontentloaded' });

    await page.waitForSelector('input[type="text"], input[name="email"], input[type="email"]', { visible: true });
    ...
    console.log("🏁 Completed! Closing browser...");
    await delay(3000);
    await browser.close();
  }
})();
